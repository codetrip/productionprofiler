...
{
    /// <summary>
    /// MethodInputOutputDataCollector collects any arguments supplied to the method as well as the return value
    ...
    /// </summary>
    public class MethodInputOutputDataCollector : IMethodInputOutputDataCollector
    {
        private readonly ISerializer _serializer;

        public MethodInputOutputDataCollector(ISerializer serializer)
        {
