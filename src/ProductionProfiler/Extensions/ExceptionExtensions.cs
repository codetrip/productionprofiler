...
namespace ProductionProfiler.Core.Extensions
{
    public static class ExceptionExtensions
    {
        ...
        {
            return Format(exception, false, false);
        }
        ...
        /// <returns></returns>
        public static String Format(this Exception exception, bool appendEnvironmentInfo)
        {
            return Format(exception, appendEnvironmentInfo, false);
        }
        ...
        /// <returns></returns>
        public static String Format(this Exception exception, bool appendEnvironmentInfo, bool reflectException)
        {
            if (exception == null)
